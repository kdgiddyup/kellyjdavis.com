...
- You can use ES6 syntax, as the project uses the Babel transpiler. If you encounter transpile errors because you do not have a particular Babel plugin, you can install it using `npm i <plugin name> -save-dev`, then add the necessary reference in `<project name>/.babelrc` file. Let a maintainer of this repo know if you do this, and the plugin can be added to the repo for future users.
